...
class Utils {
    constructor(){
        let comData = Object.assign(defaultConfig ,config)
        Object.assign(this,comData);
    }
    ...
    parseUrl(url,fn){
        if(typeof url === 'string'){
            ...
            try{
                ...
                obj_s = analy_url[2] ? analy_url[2].slice(1) : '';
                url_path = analy_url[2] ? obj_r.path.slice(1).replace(analy_url[2],"") : obj_r.path.slice(1);
